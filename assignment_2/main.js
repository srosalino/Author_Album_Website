...
function getDataToTable() {
    fetch("https://wt.ops.labs.vu.nl/api23/7579f29e", {     /* GET request using AJAX (fetch) */
        method: 'GET',
        headers: {
...
submitButton.addEventListener("click", async function (event) {    /* Adding an event listener on click actions towards the submit button */
    ...
    fetch("https://wt.ops.labs.vu.nl/api23/7579f29e", {     /* POST request using AJAX (fetch) */
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
resetButton.addEventListener("click", function () {     /* Adding an event listener on click actions towards the reset button */
    ...
    var resetAddress = "https://wt.ops.labs.vu.nl/api23/7579f29e/reset";    /* API database reset request */
...
document.getElementById("updateButton").addEventListener("click", function (event) {    /* Creating an event listener to deal with the update
    ...
    fetch("https://wt.ops.labs.vu.nl/api23/7579f29e/item/" + document.getElementById("updateId").value, {   /* PUT request using AJAX (fetch) */
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json',
        },
